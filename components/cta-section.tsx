      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-16">
          <div className="text-center">
            <p className="text-7xl font-light text-foreground">6k</p>
            <p className="text-xs text-muted-foreground uppercase tracking-wider">Nhân sự tham gia các kênh bán</p>
          </div>
          <div className="text-center">
            <p className="text-7xl font-light text-foreground">250k</p>
            <p className="text-xs text-muted-foreground uppercase tracking-wider">Khách hàng đã đăng ký tại nextgrowth</p>
          </div>
          <div className="text-center">
            <p className="text-7xl font-light text-foreground">22</p>
            <p className="text-xs text-muted-foreground uppercase tracking-wider">Đối tác tin tưởng đồng hành</p>
          </div>
        </div>
      </div>
    </section>
